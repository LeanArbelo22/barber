...
const ClientForm = () => {
  ...
  const validarFormulario = () => {
    const emailRegex = /\S+@\S+\.\S+/; // verifica que el patron sea similar a algo@algo.algo
    const telRegex = /^[0-9]{6,15}$/; // verifica que tenga solo numeros y que tenga entre 6 y 15 digitos
    return emailRegex.test(form.email) && telRegex.test(form.telefono); // retorna true o false
  };
